...
class MovieBoxHomeV2 extends StatefulWidget {
  const MovieBoxHomeV2({Key? key}) : super(key: key);

  @override
  State<MovieBoxHomeV2> createState() => _MovieBoxHomeV2State();
}

class _MovieBoxHomeV2State extends State<MovieBoxHomeV2> with TickerProviderStateMixin {
