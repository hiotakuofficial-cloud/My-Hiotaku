...
class _RecentlyAddedPageState extends State<RecentlyAddedPage> with TickerProviderStateMixin {
                ...
                child: isSearching
                    ? SlideTransition(
                        ...
                        child: SearchHandler.buildSearchBox(
                          ...
                          hintText: 'Search in Recently Added...',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text('Loading Recently Added...', style: TextStyle(color: Colors.white)),
        ],
      ),
    );
  }
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => AnimeDetailsPage(
              ...
              genres: (anime.type?.isNotEmpty ?? false) ? [anime.type!] : ['Recently Added'],
              rating: 0.0,
              year: 'Unknown',
              animeId: anime.id,
              animeType: anime.type ?? 'Recently Added',
            ),
          ),
        );
      },
